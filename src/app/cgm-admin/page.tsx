...
import { Bell, CaretRight, ChartBar, HandCoins, SignOut, User, Users, Plus, MagnifyingGlass, CaretDown, Funnel, Pencil, ArrowSquareOut, Eye, EyeSlash, CaretLeft, XCircle, Trash, CheckCircle, DotsThreeVertical, Phone, MapPin  } from "@phosphor-icons/react";
...
export default function Page(){
    ...
    const navbarIndexParams = useSearchParams();

    useEffect(() => {
        parseInt(navbarIndexParams.get('i')!) ? component.setNavbarIndex(parseInt(navbarIndexParams.get('i')!)) : component.setNavbarIndex(0);
    }, [navbarIndexParams])
    ...
    return <div className="">
        ...
        <div className="ml-64 mt-12 p-8">
            {/* <DetailWarga/> */}
            {/* //TODO: Change to DetailWarga */}
            {component.navbarIndex === 0 ? <Dashboard/> : null}
            {component.navbarIndex === 1 ? <Iuran/> : null}
            {component.navbarIndex === 2 && component.selectedUserID === 0 ? <Warga/> : <DetailWarga/>}
...
function Tentang(){
    ...
    return <>
        <div className="mt-8 w-full grid grid-cols-4 gap-8">
            ...
            <div className="col-span-3 p-4 h-fit bg-white shadow-md shadow-gray-300 flex flex-col gap-4">
