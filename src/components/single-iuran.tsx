...
export default function SingleIuran(props: {onClick?: () => void; title: string; amount: string}) {
  return <div className="flex w-full cursor-pointer" onClick={props.onClick}>
    <div className="w-full flex flex-col gap-2">
      ...
      <span className="font-semibold text-3xl">{numberFormatter(props.amount)}</span>
    </div>
