...
export default function SearchField(){
    return <div className="bg-[#F4F4F4] flex items-center rounded-xl h-12 p-1 w-96">
        <button className="h-8 w-8 ml-1 flex items-center justify-center">
            <MagnifyingGlass size={16} className="" />
        </button>
        <input type="text" placeholder="Cari Warga atau Alamat" className="px-2 bg-[#F4F4F4] text-xs flex-grow focus:outline-none" />
